...
import com.chevstrap.rbx.UI.ListFFlagsPresets;
...
public class FastflagsEditorFragment extends Fragment {
	...
	private void initialize(View view) {
		...
		//listview_flag.setOnItemLongClickListener((parent, view1, position, id) -> true);
		...
		button_deleteselected.setOnClickListener(_view3 -> {
			...
			// Remove the item at selectedFlagIndex
			...
			// If the parent activity is SettingsActivity, notify it of the removed flag key
			...
			// Show a toast confirming removal
			//Toast.makeText(getContext(), "Removed: " + (removedItem != null ? removedItem.get("name") : "Unknown"), Toast.LENGTH_SHORT).show();
