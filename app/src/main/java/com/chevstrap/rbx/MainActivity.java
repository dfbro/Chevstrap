...
public class MainActivity extends AppCompatActivity {
	...
	private void initialize() {
		...
		buttonLaunchrbx.setOnClickListener(v -> {
			try {
				launchHandler.LaunchRoblox(false);  // Roblox package name
			} catch (IOException e) {
				//e.printStackTrace();
	...
	public void LaunchWatcher() {
		...
		String rbxpath = getRBXPathDir(getApplicationContext(), FFlagsSettingsManager.getPackageTarget(getApplicationContext()));
